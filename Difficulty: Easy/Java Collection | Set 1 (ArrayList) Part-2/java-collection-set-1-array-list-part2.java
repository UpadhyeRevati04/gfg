...
class GfG
{
    ...
    {
	// Your code here
		    A.add(x); // Add the element x to the end of the list
    ...
    {
	// Your code here
	        return A.size(); // Return the size of the ArrayList
    ...
    {
	// Your code here
                A.sort(Collections.reverseOrder()); // Sort the ArrayList in descending order
    ...
    void print_ArrayList(ArrayList<Integer> A)
    {
        // Your code here
        for (int num : A) {
            System.out.print(num + " "); // Print elements separated by a space
        }
    }
}
